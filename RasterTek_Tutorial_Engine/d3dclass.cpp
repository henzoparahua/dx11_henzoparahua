...
//	Create the texture for the buffer using the filled out description.
...
//	Stencil operations if a pixel is back-facing.
...
//	With the created depth stencil state, we can now set it so that takes effect. 
